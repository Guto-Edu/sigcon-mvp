(function () {
  ...
  window.SIGCON_INITIAL_DATA = {
    ...
    fornecedores: [
      { id: 'f-pneus', razao_social: 'Pneus Forte Distribuidora Ltda', nome_fantasia: 'Pneus Forte', cnpj: '12.345.678/0001-90', responsavel: 'Rogério Batista', telefone: '(32) 3333-1010', email: 'contratos@pneusforte.com.br', endereco: 'Av. Industrial, 450 - Distrito Empresarial', certidoes: 'Regular até 20/08/2026', situacao: 'regular', sancoes: 'Sem sanções' },
      ...
      { id: 'f-merenda', razao_social: 'Nutri Escola Alimentos Ltda', nome_fantasia: 'Nutri Escola', cnpj: '47.665.120/0001-04', responsavel: 'Eduardo Paiva', telefone: '(32) 3333-4044', email: 'contratos@nutriescola.com.br', endereco: 'Av. Brasil, 1200 - Colônia', certidoes: 'Regular até 11/10/2026', situacao: 'regular', sancoes: 'Sem sanções' },
    ...
    contrato_itens: [
      { id: 'ci-pneu-175', contrato_id: 'c-pneus', descricao: 'Pneu 175/70 R14', unidade_medida: 'unidade', quantidade_contratada: 120, valor_unitario: 420, quantidade_executada: 92 },
      { id: 'ci-pneu-1000', contrato_id: 'c-pneus', descricao: 'Pneu 1000x20 borrachudo', unidade_medida: 'unidade', quantidade_contratada: 40, valor_unitario: 1950, quantidade_executada: 35 },
      { id: 'ci-praca-obra', contrato_id: 'c-praca', descricao: 'Medição global da obra - Praça do Pontilhão', unidade_medida: 'percentual', quantidade_contratada: 100, valor_unitario: 4180, quantidade_executada: 84 },
      { id: 'ci-limpeza-postos', contrato_id: 'c-limpeza', descricao: 'Postos de serviço de limpeza predial', unidade_medida: 'posto/mês', quantidade_contratada: 96, valor_unitario: 9479.17, quantidade_executada: 72 },
      { id: 'ci-merenda-cestas', contrato_id: 'c-merenda', descricao: 'Gêneros alimentícios perecíveis e não perecíveis', unidade_medida: 'lote', quantidade_contratada: 40, valor_unitario: 32000, quantidade_executada: 18 },
      ...
      { id: 'ci-saude-monitor', contrato_id: 'c-saude', descricao: 'Monitor multiparamétrico com instalação', unidade_medida: 'unidade', quantidade_contratada: 18, valor_unitario: 18500, quantidade_executada: 6 },
      { id: 'ci-saude-bomba', contrato_id: 'c-saude', descricao: 'Bomba de infusão volumétrica', unidade_medida: 'unidade', quantidade_contratada: 45, valor_unitario: 6266.67, quantidade_executada: 20 },
      { id: 'ci-transporte-rota', contrato_id: 'c-transporte', descricao: 'Rotas de transporte escolar rural', unidade_medida: 'rota/mês', quantidade_contratada: 120, valor_unitario: 14833.33, quantidade_executada: 112 }
    ],
    ordens: [
